...
test("video analysis module keeps the required isolated file structure", () => {
  for (const relativePath of [
    ...
    "src/modules/video-analysis/controllers/mediaProxyController.js",
    "src/modules/video-analysis/controllers/portableMediaController.js",
    "src/modules/video-analysis/controllers/trackingControllerHelpers.js",
    ...
    "api/_lib/video-analysis-portable-contracts.js",
    "api/_lib/video-analysis-portable-database.js",
    "api/_lib/video-analysis-portable-governance.js",
    ...
    "src/modules/video-analysis/services/localPortableMediaService.js",
    "src/modules/video-analysis/services/localTrackingBenchmarkService.js",
    "src/modules/video-analysis/services/trackingBenchmarkMetrics.js",
    "src/modules/video-analysis/services/trackingBenchmarkContract.js",
    "src/modules/video-analysis/services/trackingBenchmarkService.js",
    "src/modules/video-analysis/services/trackingBenchmarkEvidence.js",
    "src/modules/video-analysis/services/trackingBenchmarkScenarioService.js",
    "src/modules/video-analysis/services/trackingBenchmarkStateService.js",
    ...
    "src/modules/video-analysis/services/trackingCorrectionService.js",
    "src/modules/video-analysis/video-analysis.media-runtime.js",
    "src/modules/video-analysis/video-analysis.capture.css",
    "src/modules/video-analysis/video-analysis.proxy.css",
    "src/modules/video-analysis/video-analysis.portable-media.css",
    "src/modules/video-analysis/video-analysis.tracking-benchmark.css",
    "src/modules/video-analysis/video-analysis.tracking-suite.css",
    "src/modules/video-analysis/video-analysis.tracking-review.css",
    "desktop/local-video-app/local-video-server/portable-upload-client.mjs",
    "desktop/local-video-app/local-video-server/portable-upload-job-handler.mjs",
    "desktop/local-video-app/local-video-server/proxy-job-handler.mjs",
    "desktop/local-video-app/local-video-server/replay-buffer-job-handler.mjs",
    "desktop/local-video-app/local-video-server/range-asset-response.mjs",
    "desktop/local-video-app/local-video-server/tracking-provider-contract.mjs",
    "desktop/local-video-app/local-video-server/tracking-benchmark-job-handler.mjs",
    ...
    "scripts/fs-player-tracking-provider-evidence.mjs",
    "desktop/local-video-app/tracking-evaluators/trackeval/manifest.json",
    ...
    "desktop/local-video-app/tracking-evaluators/trackeval/preflight.mjs",
    "desktop/local-video-app/tracking-evaluators/trackeval/runtime/evaluator.py",
