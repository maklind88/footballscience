...
test("Medical operations renderer owns operations tabs, private system, and coach-safe summary", () => {
  ...
  expect(casesMarkup).toContain("Activate from case");
  expect(casesMarkup).toContain("Medical Plan is source");
  expect(casesMarkup).toContain("Player Profile updates");
  ...
  expect(programsMarkup).toContain("Medical-owned RTP workflow");
  expect(programsMarkup).toContain("Start from an active case");
  expect(programsMarkup).toContain("How it works");
  expect(programsMarkup).toContain("Programs are activated from a player's Medical Plan");
  expect(programsMarkup).toContain("RTP Library provides the guide");
  expect(programsMarkup).toContain("Medical-owned");
  expect(programsMarkup).toContain("Player-specific only after save");
  expect(programsMarkup).toContain("Coach-safe summary separate");
  expect(programsMarkup).toContain("Active Medical case");
  expect(programsMarkup).toContain("Apply Library guide");
  expect(programsMarkup).toContain("Save Medical Plan");
  expect(programsMarkup).toContain("Player Profile sync");
  expect(programsMarkup).toContain("Start RTP Program");
  ...
  expect(programsMarkup).toContain("Activate from case");
