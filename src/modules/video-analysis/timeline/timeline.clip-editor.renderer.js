  ...
  return `
    ...
    <form data-video-analysis-timeline-editor novalidate>
      <fieldset ${canEdit ? "" : "disabled"}>
        ...
        <div class="video-analysis-clip-editor__tags">
          <label><span>Sub-phase</span><select data-video-analysis-timeline-edit-field="subPhase">${optionList(phases, subPhase)}</select></label>
