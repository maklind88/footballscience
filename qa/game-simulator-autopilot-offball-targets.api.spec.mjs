...
test("game simulator autopilot offball targets expose moved target helpers", () => {
  ...
  expect(typeof offball.enforceOffensiveFiveLaneOccupation).toBe("function");
  expect(typeof offball.applyAutopilotTargetVariation).toBe("function");
  expect(typeof offball.applyGenerativePrincipleSupportTargets).toBe("function");
  expect(typeof offball.getOpponentBlockOccupationTarget).toBe("function");
  expect(typeof offball.applyOpponentBlockResponsiveTargets).toBe("function");
  expect(typeof offball.getGameSpaceOffBallTarget).toBe("function");
  expect(typeof offball.applyGameSpaceOffBallPrincipleTargets).toBe("function");
  expect(typeof offball.getBallNearSupportTriangleTarget).toBe("function");
  expect(typeof offball.applyBallNearSupportTriangleTargets).toBe("function");
  expect(typeof offball.getTargetLocalSuperiorityProfile).toBe("function");
  expect(typeof offball.getLocalSuperioritySupportTarget).toBe("function");
  expect(typeof offball.applyLocalSuperioritySupportTargets).toBe("function");
  expect(typeof offball.getOffensivePassingGeometryContext).toBe("function");
  expect(typeof offball.getOffensivePassingGeometryTarget).toBe("function");
  expect(typeof offball.applyOffensivePassingGeometryTargets).toBe("function");
  expect(typeof offball.getPressResistanceEscapeTarget).toBe("function");
  expect(typeof offball.applyPressResistanceEscapeSupportTargets).toBe("function");
  expect(typeof offball.getPressEscapeContinuationTarget).toBe("function");
  expect(typeof offball.applyPressEscapeContinuationTargets).toBe("function");
  expect(typeof offball.getReceptionSupportTarget).toBe("function");
  expect(typeof offball.applyReceptionSupportPrincipleTargets).toBe("function");
  expect(typeof offball.getOpenGrassCarrySupportTarget).toBe("function");
  expect(typeof offball.applyOpenGrassCarrySupportTargets).toBe("function");
  expect(typeof offball.getPostRecoveryAttackSupportContext).toBe("function");
  expect(typeof offball.getPostRecoveryAttackSupportTarget).toBe("function");
  expect(typeof offball.applyPostRecoveryAttackSupportTargets).toBe("function");
  expect(typeof offball.getOffensiveRestDefenceNetContext).toBe("function");
  expect(typeof offball.getOffensiveRestDefenceNetTarget).toBe("function");
  expect(typeof offball.applyOffensiveRestDefenceNetTargets).toBe("function");
  expect(typeof offball.getTransitionAttackTarget).toBe("function");
  expect(typeof offball.applyTransitionAttackPrincipleTargets).toBe("function");
  expect(typeof offball.getSwitchLandingAttackContext).toBe("function");
  expect(typeof offball.getSwitchLandingAttackTarget).toBe("function");
  expect(typeof offball.applySwitchLandingAttackTargets).toBe("function");
  expect(typeof offball.getBlindsideChannelRunContext).toBe("function");
  expect(typeof offball.getBlindsideChannelRunTarget).toBe("function");
  expect(typeof offball.chooseBlindsideChannelRunner).toBe("function");
  expect(typeof offball.applyBlindsideChannelRunTargets).toBe("function");
  expect(typeof offball.getSpaceTwoForwardFacingTarget).toBe("function");
  expect(typeof offball.applySpaceTwoForwardFacingTargets).toBe("function");
  expect(typeof offball.getSpaceTwoContinuationContext).toBe("function");
  expect(typeof offball.getSpaceTwoContinuationTarget).toBe("function");
  expect(typeof offball.applySpaceTwoContinuationTargets).toBe("function");
  expect(typeof offball.getPasserContinuationTarget).toBe("function");
  expect(typeof offball.applyPasserContinuationTargets).toBe("function");
  expect(typeof offball.applyThirdManChainSupportTargets).toBe("function");
  expect(typeof offball.getPositionalPlayOccupationTarget).toBe("function");
  expect(typeof offball.applyPositionalPlayOccupationTargets).toBe("function");
  expect(typeof offball.getPossessionRouteOccupationTarget).toBe("function");
  expect(typeof offball.applyPossessionRoutePrincipleTargets).toBe("function");
  expect(typeof offball.getFormationIdentityTarget).toBe("function");
  expect(typeof offball.applyFormationIdentityPrincipleTargets).toBe("function");
  expect(typeof offball.getHighValueAttackTarget).toBe("function");
  expect(typeof offball.applyHighValueSpacePrincipleTargets).toBe("function");
});
