...
const { handleSquadAgeHydrationRequest } = require("./_lib/squad-age-database.js");
...
module.exports = async (req, res) => {
  ...
  try {
    return await handleSquadAgeHydrationRequest(req, res, actor);
  } catch (error) {
    ...
    return sendJson(res, error?.status || 500, {
      ok: false,
      reason: error?.message || "Squad age hydration failed.",
    });
  }
};
