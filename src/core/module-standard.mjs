...
export const moduleStandardContracts = Object.freeze([
  ...
  createModuleStandardContract({
    ...
    currentFiles: ["app.js", "periodization-import-data.js", "src/modules/periodization/index.mjs", "src/modules/periodization/periodization-state.mjs"],
    testFiles: ["qa/critical-flows.smoke.spec.mjs", "qa/periodization-module-contract.api.spec.mjs"],
    extractionOrder: 8,
    riskLevel: "medium",
    notes: "State and merge helpers have moved into src/modules/periodization while app.js remains the renderer/controller integration shell.",
  }),
  createModuleStandardContract({
    id: "player-profiles",
    label: "Squad",
