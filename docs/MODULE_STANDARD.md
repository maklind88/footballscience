...
8. Session Planner is split into larger safe presentation/controller passes; autosave policy and block/form rendering are now extracted into `src/modules/session-planner`.
