...
async function applyTargetRowsTransactionally(config, journalId, plan, actorId, fetchImpl = fetch) {
...
export async function runAppStateTenantMigration(options, dependencies = {}) {
  ...
  try {
    await applyTargetRowsTransactionally(config, journal.row.id, plan, options.actorId, fetchImpl);
