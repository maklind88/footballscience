...
import { createSessionPlannerRuntimeServiceComposition } from "./src/modules/session-planner/session-planner-runtime-service-composer.mjs";
...
toastController: sessionPlannerToastController,
exerciseLibraryActions,
sessionFactory: sessionPlannerSessionFactory,
stateMergeHelpers: sessionPlannerStateMergeHelpers,
runtimeStateService: sessionPlannerRuntimeStateService,
getDefaultDateValue: () => formatScheduleDateValue(new Date()),
}));
...
sessionPlannerWorkspaceController = sessionPlannerRuntimeServiceComposition.sessionPlannerWorkspaceController;
