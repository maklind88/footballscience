...
export function normalizeClipInstance(value = {}) {
  ...
  return {
    ...
    matchDate: String(value.matchDate || value.match_date || value.match?.matchDate || value.match?.match_date || ""),
    eventType: String(value.eventType || value.event_type || value.match?.eventType || value.match?.event_type || ""),
    opponent: String(value.opponent || value.match?.opponent || ""),
    videoTitle: String(value.videoTitle || value.video_title || value.video?.title || ""),
    startMs,
    ...
    ownerName: String(value.ownerName || value.owner_name || value.createdByName || value.created_by_name || ""),
    createdBy: String(value.createdBy || value.created_by || ""),
    createdByName: String(value.createdByName || value.created_by_name || ""),
