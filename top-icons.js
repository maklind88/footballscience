...
"set-pieces-room": '<path d="M5 21V4M5 5c3-2 5 2 9 0v6c-4 2-6-2-9 0M3 21h8M5 21a4 4 0 0 1 4-4"/><circle cx="17.5" cy="17.5" r="4"/><path d="m17.5 15.5 1.5 1.1-.6 1.8h-1.8l-.6-1.8 1.5-1.1ZM17.5 15.5v-2M19 16.6l1.9-.6M18.4 18.4l1.1 1.6M16.6 18.4 15.5 20M16 16.6l-1.9-.6" stroke-width="1.35"/>',
...
staff: '<rect x="3" y="4" width="18" height="16" rx="2.5"/><path d="M7 8.2h10M7 15.8h10"/><circle cx="8" cy="12" r="1.7"/><circle cx="12" cy="12" r="1.7"/><circle cx="16" cy="12" r="1.7"/><path d="M8 13.7v1.1M12 13.7v1.1M16 13.7v1.1"/>',
