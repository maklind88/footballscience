...
export const moduleStandardContracts = Object.freeze([
  ...
  createModuleStandardContract({
    ...
    currentFiles: ["app.js", "src/modules/schedule/events.mjs", "src/modules/schedule/schedule-adapter.mjs"],
    testFiles: ["qa/schedule-adapter.api.spec.mjs", "qa/schedule-database-adapter.api.spec.mjs"],
    extractionOrder: 7,
    riskLevel: "medium",
    notes: "Best first UI extraction target because storage, UI, and day selection are bounded.",
  }),
  createModuleStandardContract({
    id: "periodization",
    label: "Periodization",
    ...
    currentFiles: ["app.js", "periodization-import-data.js"],
    testFiles: ["qa/critical-flows.smoke.spec.mjs"],
    extractionOrder: 8,
    riskLevel: "medium",
    notes: "Extract after Schedule so date/event consumption keeps the same event contract.",
  }),
  createModuleStandardContract({
    id: "player-profiles",
    label: "Squad",
