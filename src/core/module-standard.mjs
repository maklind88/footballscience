...
export const moduleStandardContracts = Object.freeze([
  ...
  createModuleStandardContract({
    ...
    extractionOrder: 11,
    riskLevel: "high",
    notes: "State normalization, archive/folder normalization, version snapshots, storage constants, library overlay rendering, and library actions live in src/modules/exercise-library; protected write pipeline stays in app.js until later passes. Never seed-overwrite or hard-delete saved exercises.",
  }),
  createModuleStandardContract({
    id: "session-planner",
    ...
    extractionOrder: 12,
    riskLevel: "high",
    notes: "Autosave policy, block/form rendering, tactical visual rendering, player board rendering, and print rendering now live in src/modules/session-planner; state, tactical board events, print runtime, and save flows remain in app.js for later passes.",
  }),
  createModuleStandardContract({
    id: "gameplan",
    label: "Gameplan",
