...
export const createMedicalRtpClinicalTemplate = (seed = {}) => {
  ...
  const base = {
    ...
    criteria: "clinical symptoms stable|strength and control acceptable|football exposure tolerated|no adverse next-day response",
  ...
  const templates = {
    hamstring: {
      ...
      evidence: "Hamstring RTP has moderate football evidence for prior injury, eccentric strength, sprint exposure and recurrence risk; subtype-specific evidence remains more limited.",
      experience: "Elite football staffs should expose terminal swing, curved runs, late-session sprints and position-specific high-speed actions before coach-safe match guidance.",
      redFlags: "palpable defect|rapid bruising|proximal or distal tendon suspicion|sciatic or neurological symptoms",
      criteria: "pain-free high-force hamstring testing|eccentric strength and lengthened loading acceptable|max velocity exposure completed|repeated sprint and deceleration block tolerated",
    ...
    quadriceps: {
      ...
      evidence: "Evidence is moderate for general muscle RTP principles and weaker for individual quadriceps subtypes; central tendon or avulsion features require caution.",
      ...
      criteria: "pain-free resisted knee extension|kicking volume tolerated|sprint and braking mechanics restored|no next-day anterior thigh response",
    ...
    groin: {
      ...
      criteria: "pain-free squeeze or adductor loading|adductor and hip strength acceptable|kicking volume tolerated|reactive cutting and lateral braking completed",
    ...
    calf: {
      ...
      evidence: "Calf and Achilles RTP evidence supports progressive loading and response monitoring; football-specific subtype data is limited and recurrence risk is clinically important.",
      ...
      criteria: "pain-free calf raise or push-off capacity|soleus/gastrocnemius endurance acceptable|acceleration and deceleration block tolerated|no next-day calf or tendon response",
    ...
    tendon: {
      ...
      evidence: "Tendon evidence supports progressive loading and pain-monitoring models, while exact football-specific exposure thresholds remain limited.",
      experience: "Elite football progression should not stack heavy gym loading, plyometrics, sprinting and match congestion before the tendon response is known.",
    ...
    ankle: {
      ...
      evidence: "Ankle sprain and instability evidence supports neuromuscular training and external support; syndesmosis and osteochondral subtypes require more cautious progression.",
      ...
      criteria: "swelling controlled|single-leg landing stable|reactive cutting tolerated|support, brace or tape decision agreed if needed",
    ...
    foot: {
      ...
      evidence: "Foot injury evidence varies widely by structure; high-risk midfoot, navicular and fifth metatarsal presentations require conservative medical governance.",
      ...
      criteria: "walking and push-off stable|footwear and surface tolerance confirmed|running and landing exposure tolerated|cutting and acceleration restored",
    ...
    knee: {
      ...
      evidence: "Knee RTP evidence is stronger for broad ACL/meniscus principles than for every subtype; effusion, strength and functional exposure remain key decision anchors.",
      experience: "Professional football return is often limited by late-session deceleration, reactive turns, contact confidence and swelling the next day.",
      ...
      criteria: "no reactive swelling|functional range restored|strength and landing control acceptable|rotational football exposure tolerated",
    ...
    "bone stress": {
      ...
      evidence: "Bone stress evidence supports risk stratification by site, symptoms, imaging and load response; elite football return thresholds remain partly consensus-led.",
      experience: "Medical should move conservatively when focal pain, energy availability, menstrual context or high-risk bone location is present.",
      ...
      criteria: "pain-free daily loading|medical review of imaging/risk status|graded running tolerated|jump/cutting exposure restored without next-day bone pain",
    ...
    surgical: {
      ...
      evidence: "Surgical RTP evidence is procedure-specific and often limited in elite women's football; surgeon protocol and objective response govern progression.",
      ...
      criteria: "surgeon and Medical restrictions satisfied|swelling and pain response stable|strength and movement quality acceptable|football exposure rebuilt in stages",
    ...
    neurological: {
      ...
      evidence: "Concussion and neurological RTP rely on consensus safety protocols, symptom monitoring and healthcare-provider clearance; football-specific evidence varies.",
      ...
      criteria: "medical review completed|symptoms stable at rest and exertion|cognitive/vestibular/ocular load tolerated|contact or heading progression medically cleared",
      ...
      mistakes: "same-day return|using fitness as clearance|hiding symptoms|sharing private neurological details with coaches",
    ...
    medical: {
      ...
      evidence: "Evidence is condition-specific and often consensus-led; medical diagnosis, red flags and specialist guidance govern RTP decisions.",
      ...
      criteria: "Medical confirms participation safety|systemic symptoms stable|graded exertion tolerated|privacy and coach-safe communication agreed",
