...
const { handleScoutingDatabaseRequest } = require("./_lib/scouting-database.js");
...
module.exports = async (req, res) => {
  ...
  try {
    return await handleScoutingDatabaseRequest(req, res, actor);
  } catch (error) {
    ...
    return sendJson(res, error?.status || 500, {
      ok: false,
      reason: error?.message || "Scouting database API failed.",
    });
  }
};
