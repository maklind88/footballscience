...
export function createWorkspaceRuntimeComposition(deps = {}) {
  ...
  const setPiecesRoomController = createSetPiecesRoomController({
    ...
    canDelete: deps.canDeleteSetPiecesRoom,
    getTeamMeetingReferenceUsage: deps.getSetPieceReferenceUsage,
  ...
  const playerProfileRuntimeFacade = createPlayerProfileRuntimeFacade({
    ...
    getMedicalPlayerAvailabilityStatusForDate: deps.getMedicalPlayerAvailabilityStatusForDate,
