...
test("game simulator action space metrics expose moved helpers", () => {
  ...
  expect(typeof metrics.getOrientationMovementProfile).toBe("function");
  expect(typeof metrics.getReceiveOrientationScore).toBe("function");
  expect(typeof metrics.getOpponentGoalSide).toBe("function");
  expect(typeof metrics.resolveShotTarget).toBe("function");
  expect(typeof metrics.getOffsideInfo).toBe("function");
  expect(typeof metrics.isInsideOpponentBox).toBe("function");
  expect(typeof metrics.getFirstTouchModeLabel).toBe("function");
  expect(typeof metrics.applyControlledFirstTouch).toBe("function");
  expect(typeof metrics.getAutoPilotReceiveFlowContext).toBe("function");
  expect(typeof metrics.buildAutoPilotReceiveContinuationCandidate).toBe("function");
  expect(typeof metrics.getBallTravelProgress).toBe("function");
  expect(typeof metrics.setDribbleCarryPathForBall).toBe("function");
  expect(typeof metrics.getBallFlightControlFactor).toBe("function");
