...
export const moduleStandardContracts = Object.freeze([
  ...
  createModuleStandardContract({
    ...
    cssFiles: ["dashboard-chat.css", "dashboard-chat-create.css", "dashboard-chat-launcher.css", "dashboard-chat-message.css", "dashboard-chat-experience.css"],
  ...
  createModuleStandardContract({
    ...
    cssFiles: [
      "scouting-workspace.css",
      "src/modules/scouting/scouting-experience.css",
      "src/modules/scouting/scouting-experience-details.css",
      "src/modules/scouting/scouting-experience-responsive.css",
      "src/modules/scouting/scouting-product.css",
      "src/modules/scouting/scouting-product-responsive.css",
      "src/modules/scouting/scouting-theme.css",
    ],
