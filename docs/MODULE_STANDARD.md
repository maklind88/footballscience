...
8. Session Planner is split into larger safe presentation/controller passes; autosave policy, block/form rendering, tactical visual rendering, player board rendering, and print rendering are now extracted into `src/modules/session-planner`.
