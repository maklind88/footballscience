...
| Tracking and dynamic telestration | Implemented in candidate branch | Prompt/keyframe UX, provider readiness, identity continuity, confidence and occlusion gates, manual correction, track-bound graphics, secure local jobs, pinned SAM 2.1 installer/runtime, and visible elapsed/ETA telemetry |
