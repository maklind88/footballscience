...
export function corsHeaders(request = {}, config = {}, extra = {}) {
  ...
  return {
    ...
    "access-control-allow-headers": [
      ...
      "x-football-science-proxy-spec",
      "x-football-science-replay-spec",
      "x-football-science-session",
      "x-football-science-tracking-prompt",
      "x-football-science-tracking-prompts",
      "x-football-science-tracking-provider-id",
      "x-football-science-tracking-provider-version",
      "x-football-science-tracking-source-id",
      "x-football-science-tracking-stage-request",
      "range",
    ].join(","),
