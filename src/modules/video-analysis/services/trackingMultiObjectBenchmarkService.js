...
export const MULTI_OBJECT_BENCHMARK_PROFILES = Object.freeze({
  "football-scene-pilot-v1": Object.freeze({
    ...
    thresholds: Object.freeze({
      ...
      minPersonPrecision: null,
      minPersonRecall: null,
...
const thresholdRules = Object.freeze([
  ...
  ["minPersonPrecision", "personPrecision", "minimum"],
  ["minPersonRecall", "personRecall", "minimum"],
...
function reportMetrics(frames, truthTracks, predictionTracks, profile, range, performance) {
  ...
  return {
    metrics: {
      ...
      personPrecision: metrics.perEntity.person.precision,
      personRecall: metrics.perEntity.person.recall,
