...
- `dataSafety`: this is a dedicated database-first module. It must not be added to generic `/api/app-state` persistence; workspace-access normalization may expose module visibility but owns no Leaderboard data.
