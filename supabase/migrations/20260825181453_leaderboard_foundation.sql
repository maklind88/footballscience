...
revoke all on public.leaderboard_competitions, public.leaderboard_participants,
  ...
  public.leaderboard_audit_events from public, anon, authenticated, service_role;
...
revoke all on function public.leaderboard_award_batch(uuid,uuid,uuid,uuid,uuid,date,text,date,text,text,text,text,uuid,jsonb) from public, anon, authenticated, service_role;
revoke all on function public.leaderboard_reverse_event(uuid,uuid,uuid,text,text,text,uuid) from public, anon, authenticated, service_role;
revoke all on function public.leaderboard_month_snapshot(uuid,uuid,uuid,date) from public, anon, authenticated, service_role;
revoke all on function app_private.leaderboard_actor_has_role(uuid,uuid,uuid,text[]) from public, anon, authenticated, service_role;
revoke all on function app_private.leaderboard_block_hard_delete(), app_private.leaderboard_block_append_only_mutation(),
  app_private.leaderboard_guard_event_update() from public, anon, authenticated, service_role;
